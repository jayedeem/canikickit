...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/locker.js":[function(require,module,exports) {
"use strict";
...
var search = document.querySelector('.search__bar');
var form = document.querySelector('#search');
var leftSide = document.querySelector('.left-side');
var rightSide = document.querySelector('.right-side');
var img = 'https://stockx-assets.imgix.net/media/New-Product-Placeholder-Default.jpg?fit=fill&bg=FFFFFF&w=140&h=100&auto=format,compress&trim=color&q=90&dpr=2&updated_at=0';
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(e) {
    var response, responseData, left, right;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            e.preventDefault();
            _context.next = 5;
            return _axios.default.get("https://api.thesneakerdatabase.com/v1/sneakers?limit=26&brand=".concat(search.value));

          case 5:
            response = _context.sent;
            responseData = response.data.results;
            left = responseData.splice(0, Math.floor(responseData.length / 2));
            right = responseData.splice(left, responseData.length);
            left.forEach(function (el) {
              return leftShowOutput(el);
            });
            right.forEach(function (el) {
              return rightShowOutput(el);
            });
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/locker.js"], null)
//# sourceMappingURL=/locker.829f32f2.js.map